...
<div id="search" class="container-inline">
  ...
  <input type="text" title="Enter search terms" value="" size="15" id="edit-search_theme_form" name="search_theme_form" maxlength="128" class="search-input form-text"/>
  <input type="image" class="form-submit" value="" id="edit-submit" name="op" src="/<?php print path_to_theme() ?>/images/img_search_submit.gif"/>
  <?php
  print $search["hidden"];
   ?>
</div>
